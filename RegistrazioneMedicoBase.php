...
<html>
<script language="JavaScript"src="ControlloMedicoDiBase.js">
</script>
<?php
include("BarraMenuAdmin.htm");
?>
<table width="70%" background="Immagini/sfondoFrame.png" border=0 align="center">	
 <form method="post" action="InserisciMedicoBase.php" name="registrazionemedico" onSubmit="return Controllo()">
 <tr><td colspan="3" align="center"><h2>REGISTRAZIONE MEDICO DI BASE</h2></td>
 </tr>
...
echo"ANNO";?></option>
  ...
  ?>
   ...
   <tr cellspacing=60>
	...
	<td colspan=2 align="left"><input name="Cancella" type="button" id="cancella" value="CANCELLA" onClick=location.href="RegistrazioneMedicoBase.php"></td>
   </tr>
  </table> 
 </form> 
</html>
...
$Sql="SELECT IDSPECIALISTA, NOME, COGNOME, SPECIALIZZAZIONE FROM medicispecialisti";
$rs=mysql_query($Sql);
...
print"<form action='EliminaMedSpecialista.php' method='post' name='eliminazionespecialista'>";
print"<tr><td colspan='3' align='center'><h2>ELIMINAZIONE MEDICO SPECIALISTA</h2></td></tr>";
print"<tr>";
for($i=0;$i<$ncampi;$i++)

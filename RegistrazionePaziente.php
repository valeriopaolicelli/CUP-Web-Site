...
<html>
<script language="JavaScript"src="ControlloPaziente.js">
</script>
<?php
include("BarraMenuMedBase.htm");
?>
<table width="70%" background="Immagini/sfondoFrame.png" border=0 align="center">	
 <form method="post" action="InserisciPaziente.php" name="registrazionepaziente" onSubmit="return Controllo()">
 <tr><td colspan="3" align="center"><h2>REGISTRAZIONE PAZIENTE</h2></td>
 </tr>
...
echo"ANNO";?></option>
  ...
  ?>
   ...
   <tr cellspacing=60>
	...
	<td colspan=2 align="left"><input name="Cancella" type="button" id="cancella" value="CANCELLA" onClick=location.href="RegistrazionePaziente.php"></td>
   </tr>
  </table> 
 </form> 
</html>
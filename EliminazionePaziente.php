...
$MedicoBase=$_SESSION['IDMEDICOBASE'];
$Sql="SELECT IDPAZIENTE, NOME, COGNOME, CF FROM pazienti where pazienti.FKMEDBAS='$MedicoBase' order by IDPAZIENTE";
...
echo"<form action='EliminaPaziente.php' method='post' name='eliminazionepaziente'>";

...
{var username=document.registrazionemedico.username.value;
 ...
 var idcap="checkcap";
 var okcap="true";
 var specializazione=document.registrazionemedico.Specializzazione.value;
 var ASL=document.registrazionemedico.ASL.value;
 var idasl="checkasl";
 var okasl="true";
 var imgokasl=document.createElement("IMG");
 var imgnotokasl=document.createElement("IMG");
 imgokasl.setAttribute("src","Immagini/Ok.png");
 imgnotokasl.setAttribute("src","Immagini/Err.png");
 ...
 if(cap=="CAP"){document.getElementById(idcap).innerHTML="";
                ...
                okcap="false";
				return false;}
				if(Specializzazione=="Specializzazione"){document.getElementById(idasl).innerHTML="";
                                          document.getElementById(idasl).appendChild(imgnotokasl);
                                          alert("Il campo 'Specializzazione' risulta vuoto.");
                                          document.registrazionemedico.Specializzazione.focus();
                                          okasl="false";
						                  return false;}
 if(ASL=="ASL"){document.getElementById(idasl).innerHTML="";
                document.getElementById(idasl).appendChild(imgnotokasl);
                alert("Il campo 'ASL' risulta vuoto.");
                document.registrazionemedico.ASL.focus();
                okasl="false";
				return false;}if(Specializzazione=="Specializzazione"){document.getElementById(idasl).innerHTML="";
                                          document.getElementById(idasl).appendChild(imgnotokasl);
                                          alert("Il campo 'Specializzazione' risulta vuoto.");
                                          document.registrazionemedico.Specializzazione.focus();
                                          okasl="false";
 ...
 if(ASL=="ASL"){document.getElementById(idasl).innerHTML="";
                ...
                okasl="false";
				return false;}
if(okasl=="true"){document.getElementById(idasl).innerHTML="";
                   document.getElementById(idasl).appendChild(imgokasl);
				   document.registrazionemedico.Specializzazione.value=document.registrazionemedico.Specializzazione.value.toUpperCase();
				   document.registrazionemedico.ASL.value=document.registrazionemedico.ASL.value.toUpperCase();}				
